...
public class HeadquartersController {
     ...
     */
    @PostMapping("/signup")
    public ResponseEntity<AuthDto.ApiResponse<HeadquartersDto.Response>> signup(
            @Valid @RequestBody HeadquartersDto.SignupRequest request) {
        
        log.info("본사 회원가입 요청: {}", request.getEmail());
        
        try {
            HeadquartersDto.Response response = headquartersService.signup(request);
    ...
    public ResponseEntity<AuthDto.ApiResponse<HeadquartersDto.Response>> updateHeadquartersInfo(
        ...
        try {
            HeadquartersDto.Response response = headquartersService.updateHeadquartersInfo(headquartersId, request);
    ...
    public ResponseEntity<AuthDto.ApiResponse<Void>> changeStatus(
        ...
        try {
            // Enum 변환
            var companyStatus = com.nsmm.esg.auth_service.entity.Headquarters.CompanyStatus.valueOf(status.toUpperCase());
